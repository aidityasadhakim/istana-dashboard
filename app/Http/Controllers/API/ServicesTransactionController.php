...
{
    public function servicesTransactionBetweenDate(Request $request)
    {
    ...
    public function servicesTransactionToday()
    {
        $details = Sales::selectRaw("COUNT(id) totalTransaction,
        SUM(total) total,
        CONCAT(MONTH(DATE(transaction_date)),'-',DAY(DATE(transaction_date))) AS date")
    ...
    public function servicesTransactionThisMonth()
    {
        $details = Sales::selectRaw("COUNT(id) totalTransaction,
        SUM(total) total,
        CONCAT(MONTH(DATE(transaction_date)),'-',DAY(DATE(transaction_date))) AS date")
    ...
    public function servicesTransactionLastMonth()
    {
        $details = Sales::selectRaw("COUNT(id) totalTransaction,
        SUM(total) total,
        CONCAT(MONTH(DATE(transaction_date)),'-',DAY(DATE(transaction_date))) AS date")
    ...
    public function servicesTransactionThisWeek()
    {
        $details = Sales::selectRaw("COUNT(id) totalTransaction,
        SUM(total) total,
        CONCAT(MONTH(DATE(transaction_date)),'-',DAY(DATE(transaction_date))) AS date")
    ...
    public function servicesTransactionTest()
    {
