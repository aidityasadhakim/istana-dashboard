...
class CardController extends Controller
{
    ...
    public function cardBetweenDate(Request $request)
    {
        ...
        $profit_id = DB::table('sales as s')
            ...
            ->where('is_cash', '!=', 0)
            ->whereIn('method_id', array(2, 3, 4, 5))
            ->where('status', 2)
